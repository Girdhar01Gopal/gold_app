...
class Physicsscreen extends GetView<Physicscontroller> {
 ...
 final Map<String, Map<String, List<Map<String, dynamic>>>> assignmentsData = {
    'Board': {
      'ATOMIC STRUCTURE': [
        {'assignment': 'Atomic Models', 'marks': [3.0], 'status': 'Completed'},
      ],
      'PERIODIC PROPERTIES': [
        {'assignment': 'Periodic Trends', 'marks': [8.0], 'status': 'Completed'},
        {'assignment': 'Atomic Size', 'marks': [7.0], 'status': 'Completed'},
      ],
    },
    'JEE Main': {
      'BCC': [
        {'assignment': 'Mole Concept', 'marks': [null], 'status': 'Not Started'},
        {'assignment': 'Stoichiometry', 'marks': [4.0], 'status': 'Completed'},
        {'assignment': 'Chemical Bonding', 'marks': [3.5], 'status': 'In Progress'},
        {'assignment': 'Electrochemistry', 'marks': [6.5], 'status': 'Completed'},
        {'assignment': 'Ionic Equilibrium', 'marks': [8.0], 'status': 'In Progress'},
      ],
      'ATOMIC STRUCTURE': [
        {'assignment': 'Atomic Models', 'marks': [3.5], 'status': 'Completed'},
        {'assignment': 'Quantum Numbers', 'marks': [5.0], 'status': 'Completed'},
        {'assignment': 'Bohr’s Theory', 'marks': [4.5], 'status': 'Completed'},
        {'assignment': 'De Broglie Hypothesis', 'marks': [7.0], 'status': 'In Progress'},
        {'assignment': 'Heisenberg Uncertainty Principle', 'marks': [2.0], 'status': 'Completed'},
      ],
    },
    'JEE Advanced': {
      'PERIODIC PROPERTIES': [
        {'assignment': 'Periodic Trends', 'marks': [9.0], 'status': 'Completed'},
        {'assignment': 'Electron Affinity', 'marks': [8.5], 'status': 'In Progress'},
        {'assignment': 'Ionization Energy', 'marks': [7.0], 'status': 'Completed'},
        {'assignment': 'Electronegativity', 'marks': [6.0], 'status': 'In Progress'},
        {'assignment': 'Shielding Effect', 'marks': [5.5], 'status': 'Completed'},
      ],
      'BCC': [
        {'assignment': 'Mole Concept', 'marks': [null], 'status': 'In Progress'},
        {'assignment': 'Nernst Equation', 'marks': [3.5], 'status': 'Completed'},
        {'assignment': 'Electrochemical Cells', 'marks': [7.0], 'status': 'Completed'},
        {'assignment': 'Redox Reactions', 'marks': [4.5], 'status': 'In Progress'},
        {'assignment': 'Conductivity', 'marks': [5.0], 'status': 'Completed'},
      ],
    }
  };
...
class ColorPainter {
  static const Color primaryColor = Color.fromARGB(255, 231, 217, 20);
  static const Color secondaryColor = Color(0xFFEB8A2A);
