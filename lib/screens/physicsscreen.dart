  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, List<Map<String, dynamic>>> data = {
      'SETS, RELATIONS & FUNCTIONS': [
        {'topic': 'Sets & Subsets', 'scores': [1.0, 2.5, null, 8.2, 7.8, null]},
        {'topic': 'Relations & Functions', 'scores': [3.5, 8.0, 8.2, null, 7.9, 8.0]},
      ],
      'TRIGONOMETRY': [
        {'topic': 'Trigonometric Ratios', 'scores': [5.5, 8.3, 3.0, 7.5, 8.8, null]},
        {'topic': 'Trigonometric Equations', 'scores': [7.8, 8.0, null, 4.0, 6.9, null]},
      ],
      'ALGEBRA': [
        {'topic': 'Quadratic Equations', 'scores': [1.4, 4.0, 7.5, 8.8, 5.6, null]},
        {'topic': 'Sequences & Series', 'scores': [null, 7.0, 6.5, null, 8.0, null]},
      ],
      'CALCULUS': [
